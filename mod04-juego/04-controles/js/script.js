var JuegoEstado = {
	...
	cargarControles: function(){
		this.flechaIzq = this.game.sprite(20, this.POSICIONY_BOTONES, "flecha");
		this.flechaDer = this.game.sprite(110, this.POSICIONY_BOTONES, "flecha");
		this.saltar = this.game.sprite(280, this.POSICIONY_BOTONES, "salto");
	}
